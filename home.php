    ...
    <div class="categories">
        ...
        <div class="box-container">
            <div class="box">
                ...
                <a href="categeory.php?categeory=coconut" class="btn">coconut</a>
            </div>
            <div class="box">
                <img src="image/categories0.jpg" alt="">
                <a href="categeory.php?categeory=chocolate" class="btn">chocolate</a>
            </div>
            <div class="box">
                <img src="image/categories2.jpg" alt="">
                <a href="categeory.php?categeory=strawberry" class="btn">strawberry</a>
            </div>
            <div class="box">
                <img src="image/categories1.jpg" alt="">
                <a href="categeory.php?categeory=corn" class="btn">corn</a>
            </div>
        </div>
    </div>
