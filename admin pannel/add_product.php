<?php 
	...
	if (isset($_POST['publish'])) {
		...
		$categeory = filter_var($categeory,FILTER_SANITIZE_STRING);
		...
		if ($select_image->rowCount() > 0 AND $image !='') {
			...
			$insert_post = $conn->prepare("INSERT INTO `products`(id,seller_id,name,price,image,stock, product_details,status,categeory) VALUES(?,?,?,?,?,?,?,?,?)");
			$insert_post->execute([$id,$seller_id,$title,$price,$image, $stock,$content,$status,$categeory]);
		...
		<section class="post-editor">
			...
			<div class="form-container">
				<form action="" method="post" enctype="multipart/form-data" class="register">
					...
					<div class="input-field">
						<p>Categeory <span>*</span></p>
         				<select type="name" name="categeory" required  class="box">
         				<option value=""desabled selected >select categeory --</option>
