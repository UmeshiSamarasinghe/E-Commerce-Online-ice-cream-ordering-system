<!-- -----------------newsletter----------------- -->
    <div class="newsletter">
        <div class="content">
            ...
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsam explicabo sit est eos <br> earum reprehenderit inventore nam autem corrupti rerum!</p>
            ...
            <div class="box-container">
                ...
                <div class="box">
                    <div class="box-counter"><p class="counter" data-speed="1000">1000 </p><i class='bx bx-plus'></i></div>
    ...
    <footer>
        <div class="content">
            ...
            <div class="box">
                <h3>Information</h3>
                <a href="contact.php"><i class='bx bx-chevron-right'></i>About Us</a>
            ...
            <div class="box">
                <h3>extras</h3>
                <a href="contact.php"><i class='bx bx-chevron-right'></i>Brands</a>
            ...
            <div class="box">
                <h3>contact us</h3>
                <p><i class='bx bxs-phone'></i>0912 568 523</p>
                <p><i class='bx bxs-envelope' ></i>riomagic@gmail.com</p>
                <p><i class='bx bxs-location-plus' ></i>First Lane,Galle,Srilanka</p>
                <div class="icons">
        ...
        <div class="bottom">
            <p>Copyright © 2023 code with Rio Magic. All Rights Reserved</p>
